...
func _start_video() -> void:
	...
	if noe_sfx_player:
		...
		sfx_tween.tween_property(noe_sfx_player, "volume_db", 3.0, 0.14).set_ease(Tween.EASE_IN)
...
func _show_noe_prompt() -> void:
	...
	var pre_reveal_delay: float = 2.75 - 0.16
	...
	if noe_sfx_player2:
		...
		sfx_tween2.tween_property(noe_sfx_player2, "volume_db", 3.0, 0.14).set_ease(Tween.EASE_IN)
